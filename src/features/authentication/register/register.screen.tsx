...
const RegisterScreen = ({ navigation }: any) => {
  ...
  return (
    <ThemedSafeAreaView style={{flex:1, backgroundColor: INDIGO_1}}>
      <HeaderBar title="Register" handleGoBack={handleGoBack} />
      <Layout style={styles.container}>
        <Layout style={styles.innerContainer}>
          ...
          <Input
            label={"Name"}
            placeholder="Name"
            caption={captionUsername()} //captionName
            value={username} //Name
            onChangeText={handleOnChangeUsername} //handleOnChangeName
